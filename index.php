...
<body>
	<!-- Company -->
	<div id="company" class="panel-home">
		<div class="content">
	...
	<!-- Administracion -->
	<div id="serv_admin" class="panel servicio">
		<div class="content">
			...
			<div class="container contact-form">
				<form method="POST">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-lg-6 form-input">
							<label for="type_cons">Tipo de Consulta</label>
							<select name="type_cons" id="type_cons" class="form-control input-sm" required="true">
						...
						<div class="col-xs-12 col-sm-12 collg-12 form-input">
					...
					<div class="row btn-send">
						<center>
							<button name="send" id="send" class="btn-lg-invert button-solution-lg-invert button-inverted-blue">Enviar</button>
						</center>
					</div>
				</form>
			</div>
				...
				<div class="container">
					...
					<section class="social-network">
						...
						<a href="https://www.instagram.com/solucioneskyk/" title="Soluciones K&K">
							<span class="glyphicon-2 icon-instagram-circled sociales" id="facebook"></span>
						</a>
						<!-- <a href="#" title="Soluciones K&K">
					...
					<p class="min-footer">
						...
						<!-- Copyrigth &copy; <b>Soluciones K & K C.A</b>
						J-40761208-5 -->
					</p>
				</div>
			</footer>
	...
	<nav class="nav-bar-desktop" id="nav-bar-desktop">
		<span id="btn-menu-desktop" ><span></span></span>
		<ul id="navegacion">
			<li><a class="link-section pc" href="#company">Empresa <!-- <span class="glyphicon glyphicon-home"></span> --></a></li>
			<li><a class="link-section pc" href="#serv_admin">Administración <!-- <span class="glyphicon glyphicon-briefcase"></span> --></a></li>
			<li><a class="link-section pc" href="#serv_web">Diseño Web <!-- <span class="glyphicon-2 icon-website"></span> --></a></li>
			<li><a class="link-section pc" href="#serv_marke">Publicidad & Mercadeo <!-- <span class="glyphicon glyphicon-camera"></span> --></a></li>
			<li><a class="link-section pc" href="#serv_5">Seguridad Industrial</a></li>
			<li><a class="link-section pc" href="#contact">Contactenos  <!-- <span class="glyphicon-2 icon-location-circled"></span> --></a></li>
		</ul>
	</nav>
	<nav id="menu-mobile">
		<div class="menu-logo">
		...
		<!-- <span id="btn-menu-mobile" ><span></span></span> -->
		<ul class="menu-mobile-content">
			<li><a id="link-home" href="#company"><!-- <span class="glyphicon glyphicon-home"></span> --> Empresa</a></li>
			<li><a id="link-portfolio" href="#serv_admin"><!-- <span class="glyphicon glyphicon-briefcase"></span> --> Adiministración</a></li>
			<li><a id="link-about" href="#serv_web"><!-- <span class="glyphicon-2 icon-website"></span> --> Diseño Web</a></li>
			<li><a id="link-contact" href="#serv_marke"><!-- <span class="glyphicon glyphicon-camera"></span> --> Publicidad & Mercadeo</a></li>
			<li><a id="link-contact3" href="#serv_5"><!-- <span class="glyphicon glyphicon-send"></span> --> Seguridad Industrial</a></li>
			<li><a id="link-contact2" href="#contact"><!-- <span class= "glyphicon-2 icon-location-circled"></span> --> Contactenos</a></li>
		</ul>
	</nav>
	...
	<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">¿Quienes Somos?</h5>
			</div>
	...
	<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Misión</h5>
			</div>
			<div class="modal-body">
				<p>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Visión</h5>
			</div>
			<div class="modal-body">
				<p>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Sistema de Gestión Empresarial</h5>
			</div>
			<div class="modal-body">
				<p>
					...
					<div class="row">
						<div class="col-md-offset-1 col-xs-12 col-md-7">
							<span data-toggle="collapse" data-target="#maneja">
								Permite Manjear:
							</span>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
							<div id="maneja" class="collapse">
								<dl>
					...
					<div class="row">
						<div class="col-md-offset-1 col-xs-12 col-md-7">
							<span data-toggle="collapse" data-target="#funciones">
					...
					<div class="row">
						<div class="col-md-offset-1 col-xs-12 col-md-7">
							<span data-toggle="collapse" data-target="#indicadores">
								Indicadores:
							</span>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
				...
				<br>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;Fue diseñado bajo la plataforma de Microsoft Office, en el programa Excel. Asegurando un ahorro inmediato en su inversión, debido a que hoy en día la mayoría de las computadoras tienen acceso a dicho programa, siendo más dinámica y económica la programación de nuestros expertos. De igual manera se ofrece el Servicio de Instalación de Microsoft Office para los clientes que aún no cuenten con ello en sus ordenadores.
				</p>
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#beneficios">
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Asesoramiento e Implementación de Procesos Empresariales</h5>
			</div>
			<div class="modal-body">
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;Los servicios de asesoría e implementación de procesos Empresariales le permitirán fortalecer los conocimientos que posee el dueño de la organización y sus empleados, a fin de crear bases sólidas para toma de decisiones efectivas e ir creciendo en el ámbito comercial en el que se desenvuelve la empresa.
				...
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;<b>Soluciones K&K</b> se enfoca en brindarles un servicio de calidad que se adapte a las demandas y tipo de negocio del cliente. Debido a que uno de los puntos más importantes al momento de planificar el crecimiento de su negocio, es manejar una buena Gestión Administrativa, con el propósito de tener las herramientas necesarias a la hora de evaluar la rentabilidad.
				</p>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;Es por ello que se hace necesario planificar, orientar, dirigir, controlar y evaluar las actividades de trabajo que desarrollan las empresas u organizaciones para poder ofrecer sus productos y/o servicios con eficiencia, eficacia y efectividad, así como también, mantener el nivel de calidad de las operaciones que se realizan dentro de la misma. Ya que les permite a través de uso de indicadores de gestión, tener acceso a la información más relevante acerca de los procesos que se llevan a cabo en el día a día.
				</p>
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo3">
							<b>Creación de Plan de Negocios</b>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						</span>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo4">
							<b>Creación de Estructuras de Inversiones y Gastos</b>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						</span>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo5">
							<b>Creación de Planificación Estratégica</b>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						</span>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo6">
							<b>Implementación de Estructuras Organizacionales</b>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						</span>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo7">
							<b>Implementación de Inventarios</b>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						</span>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo8">
							<b>Asesoría de Gestión Empresarial</b>
							<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						</span>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo9">
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Gestión de Empresas</h5>
			</div>
			<div class="modal-body">
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;La finalidad de los servicios ofrecidos por <b>SOLUCIONES K&K</b> es hacer que los procesos que se desempeñan dentro de las empresas se encaminen completamente hacia el cumplimiento de sus objetivos, corrigiendo a tiempo y sobre la marcha, en donde sea posible, las desviaciones o fallas que se puedan observar. Lo que se traduce como una necesidad para la supervivencia y la competitividad de las organizaciones.
				</p>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;Poniendo a disposición una amplia gama de Herramientas y aplicaciones para la organización, que permite crear y transmitir información y/o ideas entre socios, colegas y clientes de una forma sencilla, con un sistema de trabajo único y de calidad a un costo accesible, optimizando los procesos administrativos, comerciales y tiempos de entrega.
				</p>
				<p>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#gat-admin">
							Outsourcing de Gestión Administrativa
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						<div id="gat-admin" class="collapse">
							<dl>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#rrhh">
							Outsourcing de Recursos Humanos
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						<div id="rrhh" class="collapse">
							<dl>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#contabilidad">
							Outsourcing de Contabilidad
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						<div id="contabilidad" class="collapse">
							<dl>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Diseño y Desarrollo de Páginas WEB</h5>
			</div>
			<div class="modal-body">
			<p>
			...
			<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo10">
							<b>Servicios</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						<div id="demo10" class="collapse">
							<dl>
								<dd>
									- Diseño y desarrollo de Pagina WEB.
								</dd>
								<dd>
									- Desarrollo de Pagina WEB.
									<span class="small"><b>(En caso de que el cliente disponga de su diseñador para las imágenes, fondos y estilos de su página WEB)</b></span>
								</dd>
								<dd>
									- Diseño de Pagina WEB.
									<span class="small"><b>(En caso de que el cliente disponga de su desarrollador y necesite diseñar las imágenes, fondos y estilos de su página WEB)</b></span>
								</dd>
							</dl>
						</div>
					</div>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Promociones</h5>
			</div>
			<div class="modal-body">
				<p>
					En <b>Soluciones K&K</b>, le proporcionamos a su organización el Servicio de promociones de ventas, con un personal altamente calificado para satisfacer los requerimientos más allá de sus expectativas en el competitivo mundo de los negocios, respaldando dicha actividad con un conjunto de ideas, planes y acciones comerciales que refuerzan la venta activa y la publicidad, apoyando el flujo del producto al consumidor.
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo11">
							<b>Eventos</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo12">
							<b>Entrenamiento</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo13">
							<b>Exhibiciones</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo14">
							<b>Investigación de Mercado</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo15">
							<b>Merchandising</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Asesoría de Ventas y Mercadeo</h5>
			</div>
			<div class="modal-body">
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;En <b>Soluciones K&K</b>, le proporcionamos a su organización el Servicio de asesoría de Ventas, con un personal altamente calificado para satisfacer sus requerimientos más allá de sus expectativas en el competitivo mundo de negocios, respaldando dicha actividad, con los estándares más actualizados del mercado.
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo16">
							<b>Asesoría sobre:</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo17">
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Seguridad Industrial</h5>
			</div>
			<div class="modal-body">
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;Toda organización tiene el deber de lograr un ambiente que esté libre de accidentes. En este sentido, <b>Soluciones K&K</b> le ofrece todo el asesoramiento y servicios necesarios para cumplir las reglamentaciones especiales en las distintas ciudades o estados a nivel nacional. Nos adaptamos a sus exigencias y presupuesto destinado para ello, de acuerdo al tipo de actividad que se desarrolla, pudiendo ser muy estricta en algunos casos específicos a nivel legal.
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-7">
						<span data-toggle="collapse" data-target="#demo18">
							<b>Servicios:</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content modal-content-service">
			<div class="modal-header">
				...
				<h5 class="modal-title bold">Sistemas de detección, extinción y Alarma contra incendio</h5>
			</div>
			<div class="modal-body">
				<p>
				...
				<div class="row">
					<div class="col-md-offset-1 col-xs-12 col-md-10">
						<span data-toggle="collapse" data-target="#demo19">
							<b>Servicios:</b>
						</span>
						<h3 class="glyphicon-2 icon-angle-double-down"></h3>
						<div id="demo19" class="collapse">
							<dl>
								...
								<dd>- Servicio de Mantenimiento de Sistemas de Detección y Alarma Contra Incendio. <b>(Requisito exigido en normativa de Bomberos)</b></dd>
								<dd>- Servicio de Mantenimiento a Sistemas de Iluminación de Emergencia, Incluye cambio de Baterías de ser necesario. <b>(Requisito exigido en normativa de Bomberos)</b></dd>
								<dd>- Servicio de Recarga de Extintores con certificación de SENCAMER de la Compañía a realizar la Recarga. <b>(Requisito exigido en normativa de Bomberos)</b></dd>
